...
{
	private static BattleShipsGame _theGame = null;
	...
	public static void StartGame()
	{
		...
		//create the players
		switch(_aiSetting) //note: no easy?
		{
		...
		//_human.PlayerGrid.Changed += new System.EventHandler(GridChanged);
		(_ai as Player).PlayerGrid.Changed += GridChanged;
	 ...
	 */
	private static void GridChanged(object sender, EventArgs e)
	{
		DrawScreen();
	...
	private static void CheckAttackResult(AttackResult result)
	{
		...
		{
			case ResultOfAttack.Miss:
				//NOTE: Not sure if == will properly compare both
