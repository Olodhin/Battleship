...
public static class UtilityFunctions
{
	...
	public static readonly Color SMALL_SEA = SwinGame.RGBAColor(6, 60, 94, 255);
	public static readonly Color SMALL_SHIP = Color.Gray;
	public static readonly Color SMALL_MISS = SwinGame.RGBAColor(1, 147, 220, 255);
	public static readonly Color SMALL_HIT = SwinGame.RGBAColor(169, 24, 37, 255);
	
	public static readonly Color LARGE_SEA = SwinGame.RGBAColor(6, 60, 94, 255);
	public static readonly Color LARGE_SHIP = Color.Gray;
	public static readonly Color LARGE_MISS = SwinGame.RGBAColor(1, 147, 220, 255);
	public static readonly Color LARGE_HIT = SwinGame.RGBAColor(252, 2, 3, 255);
	
	public static readonly Color OUTLINE_COLOR = SwinGame.RGBAColor(5, 55, 88, 255);
	public static readonly Color SHIP_FILL_COLOR = Color.Gray;
	public static readonly Color SHIP_OUTLINE_COLOR = Color.White;
	public static readonly Color MESSAGE_COLOR = SwinGame.RGBAColor(2, 167, 252, 255);
	
	public const int ANIMATION_CELLS = 7;
	public const int FRAMES_PER_CELL = 8;
	
	public const int SMALL_FIELD_LEFT = 39;
	public const int SMALL_FIELD_TOP = 373;
	public const int SMALL_FIELD_WIDTH = 166;
	public const int SMALL_FIELD_HEIGHT = 166;
	public const int SMALL_FIELD_CELL_HEIGHT = 13;
	public const int SMALL_FIELD_CELL_WIDTH = 13;
	public const int SMALL_FIELD_CELL_GAP = 4;
								 ...
								 int cellHeight, int cellGap)
	{
		...
		for(int row = 0; row < 10; row++)
		{
			...
			for(int col = 0; col < 10; col++)
			{
				...
				//default to small_miss (may need to change)
				Color fillColor = SMALL_MISS;
				bool draw = true;
				
				switch(grid.Item(row, col))
				{
					//REPEATED CASES (Below)
					//case TileView.Ship: 
					//	draw = false;
	...
	{
		for(int i = 0; i < ANIMATION_CELLS * FRAMES_PER_CELL; i++)
		{
			UpdateAnimations();
