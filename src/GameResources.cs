...
public static class GameResources
{
	...
	/*
	 * <summary>
	 * Gets a font loaded from resources
	 * </summary>
	...
	/*
	 * <summary>
	 * Gets a image loaded from resources
	 * </summary>
	...
	/*
	 * <summary>
	 * Gets a sound loaded from resources
	 * </summary>
	 * <param name="sound"> Name of sound </param>
	 * <returns> the sound loaded with this name </returns>
	 */
	...
	/*
	 * <summary>
	 * Gets a music loaded from resources
	 * </summary>
	 * <param name="music"> Name of music </param>
	 * <returns> the music loaded with this name </returns>
	 */
	...
	public static void LoadResources()
	{
		...
		ShowMessage("Loading images...", 0);
		LoadImages();
		SwinGame.Delay(100);
		
		ShowMessage("Loading sounds...", 0);
		LoadSounds();
		SwinGame.Delay(100);
		
		ShowMessage("Loading music...", 0);
		LoadMusic();
		SwinGame.Delay(100);
	...
	private static void ShowMessage(string message, int number)
	{
		...
		SwinGame.DrawBitmap(_LoaderEmpty, BG_X, BY_Y);
		SwinGame.DrawCell (_LoaderFull, 0, BG_X, BY_Y);
